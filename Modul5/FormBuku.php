                ...
                <div class="form-card">
                    <form method="POST">
                        <div class="mb-3 mt-3">
                            ...
                            <input type="text" name="id_buku" value="<?php echo $data['id_buku']; ?>"
                                placeholder="masukkan id_buku" required class="form-control col-form-label-sm">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Judul</label>
                            <input type="text" name="judul_buku" value="<?php echo $data['judul_buku']; ?>"
                                placeholder="masukkan judul_buku" required class="form-control col-form-label-sm">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Penulis</label>
                            <input type="text" name="penulis" value="<?php echo $data['penulis']; ?>"
                                placeholder="masukkan penulis" required class="form-control col-form-label-sm">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Penerbit</label>
                            <input type="text" name="penerbit" value="<?php echo $data['penerbit']; ?>"
                                placeholder="masukkan penerbit" required class="form-control col-form-label-sm">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Tahun Terbit</label>
                            <input type="number" name="tahun_terbit" value="<?php echo $data['tahun_terbit'] ?>"
                                placeholder="masukkan tahun_terbit" required class="form-control col-form-label-sm"
                                min="1900" max="2099">
                        </div>
            ...
            <div class="col-sm-5 mx-auto">
                <div class="form-card">
                    <form method="POST">
                        <div class="mb-3 mt-3">
                            <label class="form-label">ID</label>
                            <input type="text" name="id_buku" placeholder="masukkan id_buku" required
                                class="form-control col-form-label-sm">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Buku</label>
                            <input type="text" name="judul_buku" placeholder="masukkan judul_buku" required
                                class="form-control col-form-label-sm">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Penulis</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label">Tahun Terbit</label>
                            <input type="number" name="tahun_terbit" placeholder="masukkan tahun_terbit" required
                                class="form-control col-form-label-sm" min="1900" max="2099">
                        </div>
